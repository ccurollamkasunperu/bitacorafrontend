...
@Component({
  selector: 'app-inventario-teclado',
  templateUrl: './inventario-teclado.component.html',
  styleUrls: ['./inventario-teclado.component.css']
})
export class InventarioTecladoComponent implements OnInit {
modalRef: BsModalRef;

  titulopant : string = "Registrar Teclado"
