...
export class InventarioComponent implements OnInit {
  ...
  InventarioFicha(idrec:number){
    this.router.navigate(["/inventario-ficha/"+idrec]);
  }
  
  InventarioMonitor(idrec:number){
    this.router.navigate(["/inventario-monitor/"+idrec]);
  }
  
  InventarioTeclado(idrec:number){
    this.router.navigate(["/inventario-teclado/"+idrec]);
  }
