...
@Component({
  selector: 'app-modal-teclado',
  templateUrl: './modal-teclado.component.html',
  styleUrls: ['./modal-teclado.component.css']
})
export class ModalTecladoComponent implements OnInit {
